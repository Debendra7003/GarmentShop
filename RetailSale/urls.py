...
from .views import DailySalesView, MonthlySalesView, YearlySalesView,GetOrderDetailsView,ItemStockSummaryView
urlpatterns = [
    path('create-order/', CreateOrderView.as_view(), name='create-order'),
    path('create-order/', GetOrderDetailsView.as_view(), name='create-order'),
